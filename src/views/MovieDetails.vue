<template>
  <div class="movieDetails w-full h-screen grid grid-cols-2">
    ...
    <div class="poster row-span-2 border">Poster</div>
    <div class="fullCast p-5">
      <div class="directors grid grid-cols-6">
        <p class="col-start-1 col-end-1">Directors</p>
      ...
      <div class="writers grid grid-cols-6">
        <p class="col-start-1 col-end-1">Writers</p>
        <div class="col-start-2 col-end-7 flex flex-wrap">
      ...
      <div class="actors grid grid-cols-6">
        <p class="col-start-1 col-end-1">Actors</p>
        <div class="col-start-2 col-end-7 flex flex-wrap">
      ...
      <div class="movieYear grid grid-cols-6">
        <p class="col-start-1 col-end-1">Movie year</p>
    ...
    <div class="reviews col-span-2 p-5">
      Reviews
      <div v-for="review in reviews.items" :key="review.username" class="my-5 relative block overflow-hidden rounded-lg border border-gray-100 p-8 w-9/12">
        ...
        <div class="justify-between sm:flex">
          <div>
            ...
            <p class="mt-1 text-xs font-medium text-gray-600">{{ review.username }}</p>
          </div>
        </div>
...
const requestOne = axios.get(
  `https://imdb-api.com/en/API/Title/k_qpymkukz/${route.params.id}/Posters,FullCast`
)
